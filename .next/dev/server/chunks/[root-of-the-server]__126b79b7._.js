...
"[project]/src/app/api/rooms/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const room = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT * FROM rooms WHERE id = ?').get(id);
        if (!room) {
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('DELETE FROM rooms WHERE id = ?');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__126b79b7._.js.map