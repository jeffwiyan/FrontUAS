...
async function GET(request, { params }) {
    try {
        ...
        const appointment = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
      SELECT
        a.*,
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        const stmt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('DELETE FROM appointments WHERE id = ?');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e5deadc._.js.map